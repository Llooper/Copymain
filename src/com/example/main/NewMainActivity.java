...
public class NewMainActivity extends Activity{
	...
	//紧急联系船号，需要更改
	private static final int EMERGENCY_ARK_NUM = 1;
...
//				Intent intent = new Intent(context,GeoPre.class);
//                startActivity(intent);

				Intent intent = new Intent(NewMainActivity.this,register2.class);
				startActivity(intent);
			}
		});
...
//				openOptionsMenu();
				...
				data.putInt("ark_num", EMERGENCY_ARK_NUM);
...
//    }
    ...
    public void onPause(){
    	...
    	if(globalID.un_stop)return;
    		...
    		globalID.setCurrent_code(currIndex);
    		globalID.create_notification("后台接收数据", "后台运行", "岸客户端", false, false, false,NewMainActivity.class.getName());
			if(globalID.toast != null)globalID.toast.cancel();
//			globalID.clear();
//	    	context.finish();
    	}
