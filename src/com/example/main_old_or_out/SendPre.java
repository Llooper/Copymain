...
//	
//	private String TAG = "SendPre";
//	
//	private EditText et_pre_send;
//	private ListView mListView;
//	private Button btn_pre_send_Cancel,btn_pre_send_delete;
...
//					Intent intent = new Intent(SendPre.this,MsgTalk.class);
//					
//					//post data
...
//		 btn_pre_send_Cancel.requestFocus();
...
//			e.printStackTrace();
//			Log.v("sendPre","onResume UnknownHostException "+e);
//		}
...
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//			Log.v("sendPre","onResume IOException "+e);
//		}
//
...
//			// TODO Auto-generated catch block
//			e2.printStackTrace();
//			Log.v("sendPre","onResume IOException "+e2);
//		}
//		 out.flush();
//		 out.println(4);
...
//			// TODO Auto-generated catch block
//			e.printStackTrace();
//			Log.v("sendPre","onResume SocketException "+e);
//		}
...
//			// TODO Auto-generated catch block
//			e1.printStackTrace();
//			Log.v("sendPre","onResume UnsupportedEncodingException "+e1);
//		} catch (IOException e1) {
//			// TODO Auto-generated catch block
//			e1.printStackTrace();
//			Log.v("sendPre","onResume IOException "+e1);
//		}
//		 String line = null;
//		try {
...
//					mAdapter.notifyDataSetChanged();
////					Log.v("search_ark","get id");
//					}
//			}
//	        
//	        if(globalID.getAll().size() == 0){
//				if(globalID.toast != null)globalID.toast.cancel();
//				globalID.toast = Toast.makeText(SendPre.this, "没有船号信息", Toast.LENGTH_LONG);
//				globalID.toast.show();
//			}
//		}
//		
