...
//import com.example.main.personAdapter;
//
...
//
//
//public class person_message extends ListActivity{
//	
//	//test data
//		static int k = 0;
//		
...
//		
//		private List<personEntity> mDataArrays = new ArrayList<personEntity>();
//
//		@Override 
...
//				
//				Intent intent = new Intent(person_message.this,personInfo.class);
//				
//				//post data
...
//			mListView = (MsgListView)findViewById(android.R.id.list);
//			
//			mListView.setBackgroundColor(android.graphics.Color.parseColor("#330099"));
//			
//			mAdapter = new personAdapter(this , mDataArrays);
